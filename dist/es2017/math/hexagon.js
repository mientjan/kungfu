...
export class Grid {
    ...
    static triangularShapeByLength(length, toConvert) {
        var hexes = [];
    ...
    static getRangeFromCube(cube, size) {
        return [
    ...
    static hexagonSpiralShape(size) {
        var N = size;
    ...
    static getHexagonSpiralShapeByLength(total) {
        var N = 1000;
        var results = [new Cube(0, 0, 0)];
        for (var k = 0; k <= N; k++) {
            var H = Cube.direction(4).scale(k);
    ...
    static getSpiralShapeByLength(sides, total) {
        var N = 1000;
        var results = [new Cube(0, 0, 0)];
        for (var k = 0; k <= N; k++) {
            var H = Cube.direction(4).scale(k);
    ...
    static hexagonRange(xmin, xmax, ymin, ymax, zmin, zmax) {
    ...
    static getHexagonRangeLength(xmin, xmax, ymin, ymax, zmin, zmax) {
        // Here's the range algorithm as described in the article
        var results = 0;
        for (var x = xmin; x <= xmax; x++) {
            for (var y = Math.max(ymin, -x - zmax); y <= Math.min(ymax, -x - zmin); y++) {
    ...
    static getIdealIntersectionPositions(size0, size1, interSize) {
    ...
    static calculateByHexagonIntersectionSize2(size0, size1, intersectionSize) {
    ...
    static hexagonIntersection(point0, point1) {
    ...
    static getHexagonIntersectionLength(point0, point1) {
